...
class ContestsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create contest" do
    assert_difference('Contest.count') do
      post contests_url, params: { contest: { describe: @contest.describe, title: @contest.title } }
    end
  ...
  test "should update contest" do
    patch contest_url(@contest), params: { contest: { describe: @contest.describe, title: @contest.title } }
